document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            contactForm.querySelectorAll('input[type="email"]').forEach(input => {
            ...
            // Validate textarea
            contactForm.querySelectorAll('textarea[required]').forEach(textarea => {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '57432423-b008-4875-9ba6-009c581505ef',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '57432423-b008-4875-9ba6-009c581505ef';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57432423-b008-4875-9ba6-009c581505ef';
